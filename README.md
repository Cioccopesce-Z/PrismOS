# PrismOS
os in base x86 built from scratch for learning purpose idk everything but i'm trying to collect as many knowlege as possible either from youtube and osdev.org
